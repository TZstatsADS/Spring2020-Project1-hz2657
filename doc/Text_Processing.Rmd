...
---
\
![](https://camo.githubusercontent.com/fea5a6870762e194b7abab73963021aa20de309b/68747470733a2f2f626c6f672e6f75702e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031362f30322f313236302d6d757369632e6a7067)
\
...
In the lyrics dataset, there are 7534 Country songs, 18697 Pop songs,  8905 Hip-Hops, and 2174 R&B songs. 
...
Pop and country are simiar. The most frequent words include Love, baby, heart, girl/boy, eyes, world.

Pop contains more words: chorus, 
...
# barplot
barplot(tidy_country[1:30,]$n, las = 2, names.arg = tidy_country[1:30,]$word,
...
# barplot
barplot(tidy_hiphop[1:20,]$n, las = 2, names.arg = tidy_hiphop[1:20,]$word,
...
# barplot
barplot(tidy_RB[1:20,]$n, las = 2, names.arg = tidy_RB[1:20,]$word,
