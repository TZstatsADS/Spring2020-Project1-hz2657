...
The most frequent word in Pop and ___ is Love. It contains similar topics including ____ (remove love)
...
# barplot
barplot(tidy_pop[1:20,]$n, las = 2, names.arg = tidy_pop[1:20,]$word,
