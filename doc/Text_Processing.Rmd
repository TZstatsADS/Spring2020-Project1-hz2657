...
# select top 40
par(mfrow=c(1,2))
tidy_pop1 = tidy_pop[1:40,]

ggplot(data=tidy_pop1, aes(x=word,y=n),color = tidy_pop1$word,main ="Pop - Most frequent words",
        ylab = "Words")+
...
# select top 40
tidy_country1 = tidy_country[1:40,]
...
also words like: ya, yo, ... typical hiphops
...
# select top 40
par(mfrow=c(1,2))
tidy_hiphop1 = tidy_hiphop[1:40,]

ggplot(data=tidy_hiphop1, aes(x=word,y=n),color = tidy_hiphop1$word,main ="Pop - Most frequent words",
        ylab = "Words")+
...
# select top 40
tidy_RB1 = tidy_RB[1:40,]

ggplot(data=tidy_RB1, aes(x=word,y=n),color = tidy_RB1$word,main ="Pop - Most frequent words",
        ylab = "Words")+
